    ...
    for (let i = 0; i < Math.ceil(totalDocuments / 8); i++) {
      buttons.push(
        <div
          ...
          className={
            i + 1 == page
              ? "p-2 px-4 cursor-pointer bg-slate-900 scale-110 rounded-md text-white transition-all duration-150"
              : "p-2 px-4 cursor-pointer hover:bg-slate-900 rounded-md  hover:text-white transition-all duration-150"
          }
        >
          {i + 1}
        </div>
